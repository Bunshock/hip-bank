...
public class GlobalExceptionHandler {
    ...
    // Handle id generation exceptions
    ...
    public ResponseEntity<ResponseErrorDTO> handleInvalidInput(
    ...
    public ResponseEntity<ResponseErrorDTO> handleInsufficientFundsException(
